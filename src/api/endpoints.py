...
api.add_resource(skills.Skill_List, api_version + '/findbyskill/<string:skill>', endpoint='findbyskill')
api.add_resource(skills.Skill_Update, api_version + '/skills' ,endpoint='updateskills')
